...
export default class WelcomePage extends Component {     
  ...
  />
    ...
    <View style={{alignItems:'center', justifyContent:'center'}}>
    <TouchableOpacity activeOpacity={0.8}><View style={{width:75, height:75, borderRadius:75, backgroundColor:"#23262D", alignItems:'center', justifyContent:'center', elevation:5,}}><AntDesign name="camerao" size={30} color="white" /></View></TouchableOpacity>
