...
return (
    <View style={styles.container}>
        <View style={{flex:0.75,}}>
          ...
          style={{height:350, width:250, marginTop:50,}}
          />
          ...
          <View style={{width:140, height:140, borderRadius:140, position:"absolute", top:230, right:40, borderColor:"#646874", borderWidth:40,}}></View>
          <View style={{width:75, height:75, borderRadius:75, position:"absolute", top:160, right:165, borderColor:"#23262D", borderWidth:25,}}></View>
        </View>
        <View style={{flex:0.4, paddingHorizontal:40,}}>
          <Text style={{color:'white', fontSize:23, fontFamily:'MuliSemi'}}>A revolutionary management app for diabetics</Text>
          <Text style={{color:'white', fontSize:18, paddingTop:5, fontFamily:'MuliLight', opacity:0.8}}>The only application you will ever need to manage your diabetes</Text>
